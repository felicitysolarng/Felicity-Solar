            ...
            <div className="mx-auto flex max-w-md flex-col rounded-lg lg:max-w-screen-xl lg:flex-row">
                ...
                <div className="border border-gray-100 shadow-gray-500/20 mt-8 mb-8 max-w-full bg-white shadow-sm sm:rounded-lg sm:shadow-lg lg:mt-0">
                    <div className="relative border-b border-gray-300 p-4 py-8 sm:px-8">
                        <h3 className="mb-1 inline-block text-3xl font-medium"><span className="mr-4">Get a quote!</span><span className="inline-block rounded-md bg-primary/10 px-2 py-1 text-sm text-primary sm:inline">Quick Response</span></h3>
                    ...
                    <div className="p-4 sm:p-8">
                        ...
                        <textarea id="about" className="mb-8 w-full resize-none text-sm h-30 overflow-auto rounded-lg border border-gray-300 px-4 py-2 shadow-sm focus:border-grey-400 focus:outline-none hover:border-grey-200" placeholder='Share any special requirements or enquires'></textarea>
