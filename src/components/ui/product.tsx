        ...
        <article className="max-w-sm w-full bg-white rounded-lg shadow-lg overflow-hidden dark:bg-gray-700">
            ...
            <div className="flex flex-col group hover:bg-grey-100 hover:transition-all h-full">
                <div className="flex flex-col min-h-[171px]  gap-y-3 mt-4 px-4 roup-hover:bg-grey-800 pb-4">
                    <h2 className="text-lg xl:text-xl font-semibold text-gray-800 dark:text-gray-50">{title}</h2>
                    <span className="font-normal text-gray-600 dark:text-gray-300">{description}</span>
                    <span className="font-medium text-xs bg-grey-500 rounded-sm text-white px-1.5 py-1 dark:text-gray-50 w-fit">{category}</span>
                </div>
                <div className=" justify-between items-center flex p-4 border-t border-gray-200 dark:border-gray-500">
                    <span className="font-bold text-xl  text-gray-800 dark:text-gray-50">${price}</span>
