...
// --- Custom Extensions ---
import { Link } from "@/components/tiptap/tiptap-ui-primitive/link-extension"
import { Selection } from "@/components/tiptap/tiptap-ui-primitive/selection-extension"
import { TrailingNode } from "@/components/tiptap/tiptap-ui-primitive/trailing-node-extension"
...
// --- Tiptap UI ---
import { HeadingDropdownMenu } from "@/components/tiptap/tiptap-ui/heading-dropdown-menu/heading-dropdown-menu"
...
//import content from "@/components/tiptap/editor/data/content.json"
...
export function SimpleEditor({ content, editorStyles, handleChange, styles }: IProps) {
  ...
  // update content when prop changes (after first mount)
  React.useEffect(() => {
  ...
  return (
    <EditorContext.Provider value={{ editor }} >
      ...
      <div className={cn("content-wrapper border border-[#222325] ", styles)}>
        <EditorContent
          editor={editor}
          content={content}
          role="presentation"
