        ...
        <main className='font-[family-name:var(--font-inter)]'>
            ...
            <section className='flex justify-center flex-col mt-12 lg:mt-0 w-[90%] 2xl:w-[75%] mx-auto'>
                ...
                <div className=" items-center my-10 flex-row gap-x-1 hidden lg:flex">
                    ...
                    <Link href={"/products/felicity-solar-lights"} className='text-grey-400 items-center flex font-medium text-sm' aria-label='link to products page'> <ChevronRight color='#98A2B3' size={16} /> Solar Lights</Link>
                    ...
                    <div className="flex gap-x-10 flex-col md:flex-row">
                        ...
                        <div className="w-full md:w-1/2 md;px-4">
                            ...
                            <div className="flex items-center mb-4">
                                ...
                                <RatingStar />
                                <RatingStar />
                                <span className="ml-2 text-gray-600">4.5 (99 reviews)</span>
                            </div>
