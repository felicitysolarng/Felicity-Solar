        ...
        <main className='font-[family-name:var(--font-inter)]'>
            ...
            <section className='flex justify-center flex-col mt-12 lg:mt-0 w-[90%] 2xl:w-[75%] mx-auto'>
                <div className="flex lg:hidden my-10 ">
                    <Link href={"/felicity-solar-street-light"} className='text-grey-400 items-center flex font-medium text-sm' aria-label='link to products page'><ChevronLeft color='#98A2B3' size={16} /> Go back</Link>
                </div>
