...
function index() {
    ...
    return (
        <main className='font-[family-name:var(--font-inter)]'>
            ...
            <section className='flex flex-col pt-32 pb-18 custom-gradient'>
            ...
            <section className='flex flex-col gap-y-32  py-32 mx-auto w-[90%] 2xl:w-[75%] md:gap-x-8 lg:gap-x-26'>
                <Articles />
            </section>
