...
import { IStateResponse } from '@/components/InstallerFilter';
...
const createShowcase = async (variables: ICreateProjectShowcase) => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API}/project_showcases`, {
        method: 'POST',
        headers: {
...
function AddShowcase() {
    ...
    const mutation = useMutation({
        mutationFn: (variables: ICreateProjectShowcase) => createShowcase(variables)
    })
